...
public:
     ...
     *
     * @param advertisedServiceUuid  16-bit or 128-bit UUID to advertise
     *                               (in string form)
     *
...
private:
    ...
    const char* _service_data_uuid; /*BHN*/
    uint8_t* _service_data;         /*BHN*/
    uint8_t _service_data_length;   /*BHN*/
